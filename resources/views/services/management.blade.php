...
@section('content')
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 colorlib-heading colorlib-heading2 animate-box text-center">
                        <h2>@lang('pages.management.header-other')</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="colorlib-testimony">
        <div class="container">
            <div class="col-md-10 col-md-offset-1 text-center colorlib-heading animate-box">
                <h2>@lang('pages.management.service-header')</h2>
            </div>
            <div class="col-md-12 colorlib-services-text">@lang('pages.management.service-text')</div>
        </div>
    </div>
    ...
    <div id="colorlib-services">
        <div class="container">
            <div class="col-md-10 col-md-offset-1 text-center colorlib-heading animate-box">
                <h2>@lang('pages.management.service-consist-header')</h2>
            </div>
            <div class="col-md-12 colorlib-services-text text-center">
                <p>@lang('pages.management.service-consist-text-1')</p>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-1')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-2')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-3')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-4')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-5')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-6')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-7')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-8')</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 text-center animate-box">
                    <div class="services">
                        ...
                        <div class="desc">
                            <p>@lang('pages.management.service-consist-part-9')</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="col-md-12 colorlib-services-text text-center">
                <p>@lang('pages.management.service-consist-text-2')</p>
            </div>
        </div>
    </div>
    ...
    <div id="colorlib-testimony">
        <div class="container">
            <div class="col-md-10 col-md-offset-1 text-center colorlib-heading animate-box">
                <h2>@lang('pages.management.service-price-header')</h2>
            </div>
            <div class="col-md-12 colorlib-services-text">@lang('pages.management.service-price-text')</div>
        </div>
    </div>
@endsection
